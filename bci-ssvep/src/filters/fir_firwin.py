...
def apply_fir_firwin_and_save_csv(xdf_file_path, dir_to_save_csv, frequencies: list, seconds: tuple,
                                  sampling_rate=125, cutoff=(1, 45), numtaps=70, electrode_index=13):
    ...
    # Design the FIR filter using firwin algorithm
    filter_design = signal.firwin(numtaps, [cutoff[0] / sampling_rate, cutoff[1] / sampling_rate], pass_zero=False)
